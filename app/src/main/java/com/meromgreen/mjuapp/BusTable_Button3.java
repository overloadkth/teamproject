...
public class BusTable_Button3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bus_table__button3);
    ...
    public void setBusTable3() {
        Document doc = null;
        try {
            doc = Jsoup.connect("http://m.mju.ac.kr/mbs/mjumob/jsp/subview.jsp?id=mjumob_040205000000").get();
        } catch (IOException e) {
            e.printStackTrace();
        }
